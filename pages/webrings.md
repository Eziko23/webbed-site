...
webrings im a part of (probably)

## [SSGRing](https://jbc.lol/webrings/ssgring) (pending)
- [previous](https://jbc.lol/webrings/ssgring/redirect?slug=funkylevi&way=prev) [[random]](https://jbc.lol/webrings/ssgring/redirect?way=rand) [next](https://jbc.lol/webrings/ssgring/redirect?slug=funkylevi&way=next)
- a webring for sites made with static site generators! (i use 11ty btw)

## [bucket webring](https://webring.bucketfish.me/) (pending)
